...
FILE_DESCRIPTION = "Battlezone Font Generator"
INTERNAL_NAME = "BZFontGenerator"
ORIGINAL_FILENAME = "BZFontGenerator.exe"
...
def main() -> None:
    ...
    parser.add_argument("--version", required=True, help="Release version, for example 2.4.2 or v2.4.2")
